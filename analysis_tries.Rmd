...
Racial slurs like "chinazi", "chingchong", "chinesevirus", and similar can also be used in an ironic or maybe positve sentiment. So, the general sentiment of these tweets is computed. It shows that the dataset is more negative polarized because there are more negative senitments than twice as many as positives (negative 434 vs positive 205). This result is shown in the table and the graph below.
